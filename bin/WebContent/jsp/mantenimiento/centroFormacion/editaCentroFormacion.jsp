...
<html lang="es">
<head>
<meta charset="ISO-8859-1UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="author" content="Harry Bravo">
<meta name="description"
	content="Pagina de edicion de centro de formacion">
...
<body>
	...
	<div class="container">
		<p>
			<strong>Mantenimiento de Centro de Formación &gt; Edición</strong>
		</p>
				...
				<tr>
					...
					<td><label> <input type="file" name="logo">
							...
							<img alt="logo"
								...
								title="${centroFormacion.logo}" width="120" height="120">
						</c:if></td>
				</tr>
				<tr>
